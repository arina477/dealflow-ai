# T-4 Integration Principles — <Your Project>

Cross-wave rules specific to **T-4 (DB + service + API integration)**. Append-only; numbered sequentially. Read at every T-4 stage.
