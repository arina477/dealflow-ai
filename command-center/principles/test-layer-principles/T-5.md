# T-5 E2E Principles — <Your Project>

Cross-wave rules specific to **T-5 (Playwright tester swarm)**. Append-only; numbered sequentially. Read at every T-5 stage.
